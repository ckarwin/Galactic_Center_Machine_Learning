...
print this_max
savefile = "simulated_counts_map.png"

fig = aplpy.FITSFigure(this_file,dimensions=[0,1],slices=[0],figsize=(10,1),convention='calabretta')
fig.show_colorscale(interpolation='none',smooth=1,cmap='inferno',vmin=0,vmax=this_max)

#fig.add_grid()

plt.title("Simulated Counts Map (1 GeV, Sim B with fluctuations)", fontsize = 6)
...
fig.colorbar.set_axis_label_text('counts/pix') 
